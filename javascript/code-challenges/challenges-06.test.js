...
const getNames = (arr) => arr.map( string => string.name.split('').reduce( (accumulator, character) => character + accumulator));
...
const addBirthYearProperty = (object, year) => object.yearBorn = year;

...
const addValues = (arr) => arr.reduce( (accumulator, cVal) => accumulator += cVal, 0);
...
const addPurchases = (arr) => arr.reduce( (accumulator, cVal) => accumulator += cVal.purchasePrice, 0);
...
const returnNames = (arr) => {
  return arr.reduce( (accumulator, cVal) => {
    accumulator.push(cVal.name);
    return accumulator;
  }, []);
};
...
const reversedString = (str) => str.split('').reduce((accumulator, character) => character + accumulator, '');
